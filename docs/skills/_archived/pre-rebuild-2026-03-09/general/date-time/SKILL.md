...
Crab Claw（蟹爪） defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, Crab Claw（蟹爪） inspects the OS preference (macOS/Windows)
