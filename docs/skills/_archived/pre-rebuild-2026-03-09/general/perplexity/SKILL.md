...
Crab Claw（蟹爪） can use Perplexity Sonar for the `web_search` tool. You can connect
...
If no base URL is set, Crab Claw（蟹爪） chooses a default based on the API key source:
