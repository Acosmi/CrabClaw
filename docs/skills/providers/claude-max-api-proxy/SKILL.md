...
You can point Crab Claw（蟹爪） at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Crab Claw（蟹爪）
...
- [Anthropic provider](/providers/anthropic) - Native Crab Claw（蟹爪） integration with Claude setup-token or API keys
