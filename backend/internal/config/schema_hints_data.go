...
// schema_hints_data.go — 自动生成自 src/config/schema.ts
// 对应 TS FIELD_LABELS + FIELD_HELP + FIELD_PLACEHOLDERS + GROUP_LABELS + GROUP_ORDER

import "regexp"

// groupLabels 对应 TS GROUP_LABELS
...
// sensitivePatterns 对应 TS SENSITIVE_PATTERNS
...
// isSensitivePath 检查路径是否匹配敏感字段模式
...
// fieldLabels 对应 TS FIELD_LABELS (290 条)
var fieldLabels = map[string]string{
	"meta.lastTouchedVersion":                                       "Config Last Touched Version",
	"meta.lastTouchedAt":                                            "Config Last Touched At",
	"update.channel":                                                "Update Channel",
	"update.sourceURL":                                              "Update Source URL",
	"update.checkOnStart":                                           "Update Check on Start",
	"update.autoCheck":                                              "Desktop Auto Check",
	"update.autoDownload":                                           "Desktop Auto Download",
	"update.installPolicy":                                          "Update Install Policy",
	"update.skippedVersions":                                        "Skipped Versions",
	"update.lastCheckedAt":                                          "Last Checked At",
	"update.lastSeenVersion":                                        "Last Seen Version",
	...
	// Phase 6: 中国频道字段标签
	"channels.feishu":             "飞书 / Feishu",
	"channels.feishu.appId":       "App ID",
	"channels.feishu.appSecret":   "App Secret",
	"channels.feishu.domain":      "Domain (feishu/lark)",
	"channels.feishu.dmPolicy":    "飞书 DM Policy",
	"channels.dingtalk":           "钉钉 / DingTalk",
	"channels.dingtalk.appKey":    "App Key",
	"channels.dingtalk.appSecret": "App Secret",
	"channels.dingtalk.robotCode": "Robot Code",
	"channels.dingtalk.token":     "Token",
	"channels.dingtalk.aesKey":    "AES Key",
	"channels.dingtalk.dmPolicy":  "钉钉 DM Policy",
	"channels.wecom":              "企业微信 / WeCom",
	"channels.wecom.corpId":       "Corp ID",
	"channels.wecom.secret":       "Secret",
	"channels.wecom.agentId":      "Agent ID",
	"channels.wecom.token":        "Token",
	"channels.wecom.aesKey":       "Encoding AES Key",
	"channels.wecom.dmPolicy":     "企业微信 DM Policy",
}
...
var fieldHelp = map[string]string{
	...
	"update.channel":                                                "Update channel for desktop releases (\"stable\", \"beta\", or \"dev\").",
	"update.sourceURL":                                              "Base URL of the desktop release source, or an exact update.json URL for the updater to query.",
	"update.checkOnStart":                                           "Legacy alias for autoCheck. Kept for backwards compatibility during migration.",
	"update.autoCheck":                                              "Check for desktop updates automatically when the app starts.",
	"update.autoDownload":                                           "Download desktop updates automatically after they are discovered.",
	"update.installPolicy":                                          "When a downloaded desktop update should be installed: \"manual\", \"on-quit\", or \"idle\".",
	"update.skippedVersions":                                        "Versions the user has chosen to dismiss temporarily.",
	"update.lastCheckedAt":                                          "ISO timestamp of the most recent update check (auto-maintained).",
	"update.lastSeenVersion":                                        "Most recent remote desktop version observed by the updater (auto-maintained).",
	...
	"gateway.controlUi.basePath":                                    "Optional URL prefix where the Control UI is served (e.g. /openacosmi).",
	...
	"diagnostics.cacheTrace.filePath":                               "JSONL output path for cache trace logs (default: $OPENACOSMI_STATE_DIR/logs/cache-trace.jsonl).",
	...
	"tools.web.search.provider":                                     "Search provider (\"bocha\" or \"google\").",
	"tools.web.search.apiKey":                                       "Bocha Search API key (fallback: BOCHA_API_KEY env var).",
	"tools.web.search.maxResults":                                   "Default number of results to return (1-10).",
	"tools.web.search.timeoutSeconds":                               "Timeout in seconds for web_search requests.",
	"tools.web.search.cacheTtlMinutes":                              "Cache TTL in minutes for web_search results.",
	"tools.web.search.google.apiKey":                                "Google Custom Search API key.",
	"tools.web.search.google.searchEngineId":                        "Google Programmable Search Engine ID.",
	...
	"agents.defaults.memorySearch.store.path":                       "SQLite index path (default: ~/.openacosmi/memory/{agentId}.sqlite).",
	...
	"plugins.installs.*.installPath":                           "Resolved install directory (usually ~/.openacosmi/extensions/<id>).",
	...
	// Phase 6: 中国频道帮助文本
	"channels.feishu.appId":       "飞书开放平台 App ID。",
	"channels.feishu.appSecret":   "飞书开放平台 App Secret。",
	"channels.feishu.domain":      "飞书域名：\"feishu\" 或 \"lark\" (国际版)。",
	"channels.feishu.dmPolicy":    "私聊访问控制 (\"pairing\" 推荐)。",
	"channels.dingtalk.appKey":    "钉钉开放平台 AppKey。",
	"channels.dingtalk.appSecret": "钉钉开放平台 AppSecret。",
	"channels.dingtalk.robotCode": "机器人代码 (RobotCode)，用于 Stream 模式认证。",
	"channels.dingtalk.token":     "回调签名 Token。",
	"channels.dingtalk.aesKey":    "回调加密 AES Key。",
	"channels.dingtalk.dmPolicy":  "私聊访问控制 (\"pairing\" 推荐)。",
	"channels.wecom.corpId":       "企业微信 CorpID（企业 ID）。",
	"channels.wecom.secret":       "应用 Secret。",
	"channels.wecom.agentId":      "应用 AgentId。",
	"channels.wecom.token":        "回调配置 Token。",
	"channels.wecom.aesKey":       "回调配置 EncodingAESKey。",
	"channels.wecom.dmPolicy":     "私聊访问控制 (\"pairing\" 推荐)。",
}
...
var fieldPlaceholders = map[string]string{
	...
	"agents.list[].identity.avatar":    "avatars/openacosmi.png",
}
